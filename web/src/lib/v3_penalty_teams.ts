...
export const V3_PENALTY_TEAMS: readonly V3PenaltyTeam[] = [
  {
    ...
    skyBottom: "#15438a",
    crowd: "#dbeafe",
    jerseyPrimary: "#1d4ed8",
    jerseySecondary: "#f8fafc",
    keeperPrimary: "#ef4444",
    keeperSecondary: "#7f1d1d",
    buttonText: "#07111f",
  },
  {
    key: "brazil",
    ...
    accent: "#facc15",
    accentLight: "#fde68a",
    accentGlow: "rgba(250,204,21,.45)",
    accentSoft: "rgba(250,204,21,.12)",
    accentBorder: "rgba(254,240,138,.38)",
    bgPage: "#071a12",
    bgCard: "#0f281f",
    borderColor: "rgba(250,204,21,.28)",
    pitchTop: "#1f7a47",
    pitchBottom: "#0f5e35",
    skyTop: "#06312b",
    skyBottom: "#0b5d48",
    ...
    keeperPrimary: "#2563eb",
    keeperSecondary: "#1e3a8a",
    buttonText: "#172400",
  },
  {
    key: "argentina",
    ...
    accent: "#38bdf8",
    accentLight: "#bae6fd",
    accentGlow: "rgba(56,189,248,.45)",
    accentSoft: "rgba(56,189,248,.12)",
    accentBorder: "rgba(186,230,253,.38)",
    bgPage: "#061723",
    bgCard: "#102432",
    ...
    jerseySecondary: "#f8fafc",
    keeperPrimary: "#f59e0b",
    keeperSecondary: "#92400e",
    buttonText: "#061922",
  },
  {
    key: "morocco",
    ...
    accent: "#ef4444",
    accentLight: "#fca5a5",
    accentGlow: "rgba(239,68,68,.44)",
    accentSoft: "rgba(239,68,68,.12)",
    accentBorder: "rgba(252,165,165,.34)",
    bgPage: "#240709",
    bgCard: "#341014",
    ...
    jerseySecondary: "#fecaca",
    keeperPrimary: "#10b981",
    keeperSecondary: "#065f46",
    buttonText: "#2b0a0e",
  },
  {
    key: "spain",
    ...
    accent: "#f59e0b",
    accentLight: "#fcd34d",
    accentGlow: "rgba(245,158,11,.42)",
    accentSoft: "rgba(245,158,11,.12)",
    accentBorder: "rgba(252,211,77,.34)",
    bgPage: "#231108",
    bgCard: "#341a0f",
    ...
    crowd: "#ffedd5",
    jerseyPrimary: "#dc2626",
    jerseySecondary: "#f59e0b",
    keeperPrimary: "#1d4ed8",
    keeperSecondary: "#1e3a8a",
    buttonText: "#241203",
  },
  {
    ...
    accent: "#22c55e",
    accentLight: "#86efac",
    accentGlow: "rgba(34,197,94,.42)",
    accentSoft: "rgba(34,197,94,.12)",
    accentBorder: "rgba(134,239,172,.34)",
    bgPage: "#07160f",
    bgCard: "#10241b",
    ...
    skyBottom: "#14532d",
    crowd: "#dcfce7",
    jerseyPrimary: "#16a34a",
    jerseySecondary: "#ef4444",
    keeperPrimary: "#facc15",
    keeperSecondary: "#854d0e",
    buttonText: "#07150c",
  },
] as const;
