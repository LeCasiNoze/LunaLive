...
export interface V3QuickInputs {
  ...
  modelKind: "M1" | "M2" | "M3" | "M4" | "M5" | "M6" | "M7" | "M8" | "M9" | "M10" | "M11" | "M12" | "M13";
...
export function buildV3GameModelPage(inputs: V3QuickInputs): V2Page {
  const kind = inputs.modelKind as "M3" | "M4" | "M5" | "M6" | "M7" | "M8" | "M9" | "M10" | "M11" | "M12" | "M13";
  ...
  const page: V2Page = {
    ...
    zones: {
      ...
      reviews: [],
      faq: [],
      footer: (kind === "M10" || kind === "M11" || kind === "M12" || kind === "M13") ? [] : [
