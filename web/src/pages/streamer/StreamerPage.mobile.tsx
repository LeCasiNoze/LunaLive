...
function pickStreamerAvatarUrlFromStreamer(streamer: any) {
  ...
  const directRaw = streamer?.avatarUrl ?? streamer?.avatar_url ?? streamer?.avatar ?? streamer?.profilePicUrl ?? streamer?.profile_pic_url ?? streamer?.profile?.avatarUrl ?? streamer?.user?.avatarUrl ?? null;
