...
function applyConfig(
  ...
  if (model === 5) {
    ...
    // ─── Override pour écrans courts (iPhone SE 375×667, iPhone 8, etc.) ─────
    // Après viewport=390, iPhone SE a une hauteur CSS de ~693px → il active
    // encore la règle agressive du template @media (max-height: 860) qui
    // applique transform: translateY(-28px) sur .hero-card → le coffre chevauche
