...
@media (min-width:900px){.hero-avatar{width:clamp(120px,12vw,176px);margin-bottom:22px}}
    ...
    // Bouton Telegram optionnel — injecte entre .brand-signature (pseudo) et
    // .offer-copy (déposez/recevez). Couleur derivée du variant pour rester
    // en adequation avec le theme de la landing.
