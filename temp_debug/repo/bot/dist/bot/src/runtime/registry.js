...
export class Registry {
    ...
    async autoCloseBotWheelEnroll(streamerId) {
        try {
            await this.pool.query(`INSERT INTO bot_wheel_cfg(streamer_id, enroll_open)
         VALUES ($1, FALSE)
         ON CONFLICT (streamer_id)
         DO UPDATE SET enroll_open=FALSE, updated_at=NOW()`, [streamerId]);
        }
        catch (e) {
