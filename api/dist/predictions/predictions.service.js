...
export async function assertStreamerLive(pool, streamerId) {
...
async function countResolvedToday(pool, streamerId) {
    const r = await pool.query(`
...
export async function createPredictionSafe(pool, streamerId, question, o1, o2, duration, stake) {
