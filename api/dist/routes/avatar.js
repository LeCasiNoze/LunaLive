...
// Auth: PUT /me/avatar
avatarRouter.put("/me/avatar", requireAuth, async (req, res) => {
    ...
    try {
        ...
        await client.query(`INSERT INTO user_avatars (user_id, mime, bytes, updated_at)
       VALUES ($1,$2,$3,NOW())`, [userId, mime, buf]);
