...
export const DLIVE = [
    {
        ...
        answer: "Tu peux lier ton compte DLive à LunaLive depuis ton dashboard streamer, dans la section Intégrations. Une fois lié, LunaLive peut synchroniser certaines données de ton stream DLive (statut live, chat…).",
        roles: ["streamer"],
        sensitivity: "low",
    ...
    },
    {
        ...
        answer: "Lier DLive à LunaLive permet à la plateforme de détecter automatiquement quand tu es en live sur DLive, de synchroniser ton statut de stream, et d'activer certaines fonctionnalités LunaLive (rubis en direct, tools) pendant tes lives DLive.",
        roles: ["streamer"],
        sensitivity: "low",
        confidence: "confirmed",
    ...
    },
    {
        ...
        answer: "Tu peux délier ton compte DLive depuis ton dashboard streamer, dans la section Intégrations. Après la déconnexion, la synchronisation automatique est désactivée.",
        roles: ["streamer"],
        sensitivity: "low",
        confidence: "inferred",
