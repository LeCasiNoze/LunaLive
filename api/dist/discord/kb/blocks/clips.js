...
export const CLIPS_BLOCKS = [
    // ── Créer un clip ──────────────────────────────────────────────────────────
    {
        ...
        what_it_is: "LunaClip permet de capturer et partager des moments forts d'un stream (jackpots, moments drôles, moments épiques). Le clip capture les dernières secondes du stream en cours.",
        how_to_do_it: [
    ...
    // ── Clips automatiques ─────────────────────────────────────────────────────
    {
        ...
        what_it_is: "LunaLive propose une fonctionnalité de clips automatiques qui peut capturer automatiquement certains moments de ton stream selon des critères définis.",
        how_to_do_it: [
