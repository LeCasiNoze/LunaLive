...
export const CALLS = [
    {
        ...
        answer: "Dans le jargon casino/gambling, un \"call\" c'est un pick de slot — une recommandation de jeu. Exemple : \"je call Dog House\" = je demande au streamer d'aller jouer sur la slot Dog House.\n\nSur LunaLive, les calls fonctionnent en file d'attente : tu choisis ta slot, tu mises des rubis pour entrer dans la file, et le streamer traite les calls un par un en direct.",
    ...
    },
    {
        ...
        answer: "Ta position dans la file des calls est visible sur la page du streamer, dans la section calls. L'ordre dépend de ton poids (lié à ta mise en rubis) et de ton heure d'entrée dans la file.",
        roles: ["viewer"],
        sensitivity: "low",
        confidence: "confirmed",
        codeRefs: ["api/src/services/calls.ts"],
    },
    {
        ...
        answer: "Oui, tu peux te retirer de la file des calls avant que ton call soit traité. Rends-toi sur la page du streamer et annule ta participation depuis la section calls. Tes rubis misés te sont alors remboursés.",
        roles: ["viewer"],
        sensitivity: "low",
        confidence: "inferred",
        codeRefs: ["api/src/services/calls.ts"],
    },
    {
        ...
        answer: "Tu peux activer ou désactiver la file des calls depuis ton dashboard streamer sur LunaLive. Tu peux aussi configurer les paramètres : mise minimum/maximum, jeux autorisés, limite de la file.",
        roles: ["streamer"],
        sensitivity: "low",
        confidence: "confirmed",
    ...
    },
    {
        ...
        answer: "Depuis ton dashboard ou l'overlay de stream, tu vois la file des calls en attente. Tu peux valider (passer au call suivant), refuser, ou gérer l'ordre manuellement. Chaque call indique le jeu proposé par le viewer et sa mise.",
        roles: ["streamer"],
        sensitivity: "low",
        confidence: "confirmed",
        codeRefs: ["api/src/services/calls.ts"],
    },
    {
        ...
        answer: "Si un call est annulé ou refusé, tes rubis misés te sont remboursés. Si tu as un doute sur un remboursement qui ne serait pas arrivé, vérifie ton historique de transactions et ouvre un ticket si nécessaire.",
        roles: ["viewer"],
        sensitivity: "medium",
        confidence: "inferred",
        escalate: true,
    ...
    },
    {
        ...
        answer: "La Hunt est une variante des calls où la mise est en euros réels (et non en rubis). C'est une fonctionnalité réservée aux streamers qui souhaitent proposer des sessions de chasse avec des mises réelles. Les conditions et modalités sont définies par le streamer.",
        roles: ["viewer", "streamer"],
        sensitivity: "high",
        confidence: "confirmed",
        escalate: true,
