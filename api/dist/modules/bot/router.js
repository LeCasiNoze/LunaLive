...
import { BOT_TEXT_MAX, CommandCreateSchema, CommandPatchSchema, AutopostCreateSchema, AutopostPatchSchema, LogsQuerySchema, TestSendSchema, } from "./schemas.js";
import { getMyStreamer, listCommands, createCommand, patchCommand, deleteCommand, listAutoposts, createAutopost, patchAutopost, deleteAutopost, listLogs, clearLogs, enqueueTestSend, } from "./repo.js";
export const meBotRouter = express.Router();
// helper
async function mustGetMyStreamer(req) {
