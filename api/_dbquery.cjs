...
const pool = new Pool({ connectionString: 'postgresql://lunalive_db_user:gSIR5ZD1Bf3dcKlYYmVkobKYjkjYxY4q@dpg-d505pcu3jp1c73f1t7e0-a.oregon-postgres.render.com/lunalive_db', ssl: { rejectUnauthorized: false } });
Promise.all([
