...
export const BOT_TOOLS_BLOCKS: KbBlock[] = [
...

  {
    ...
    what_it_is:
      "La roue est un tirage au sort organisé par le streamer. Tu paies des rubis pour entrer. Plus tu mises, plus ton poids dans le tirage est élevé. Un gagnant est tiré à la fin.",
    how_to_do_it: [
...

  {
    ...
    what_it_is:
      "La pluie (rain) est une distribution automatique de rubis lancée par le streamer. Les rubis sont répartis équitablement entre tous les viewers actifs présents au moment du déclenchement.",
    how_to_do_it: [
...

  {
    ...
    what_it_is:
      "Les prédictions permettent de parier des rubis sur l'issue d'un événement posé par le streamer (ex : \"Je vais faire un jackpot ?\"). Les gagnants remportent une part de la cagnotte totale.",
    how_to_do_it: [
...

  {
    ...
    what_it_is:
      "Le coffre est un pot commun de rubis créé par le streamer. Il suffit de cliquer pour participer. À la fermeture, les rubis sont divisés équitablement entre tous les participants.",
    how_to_do_it: [
