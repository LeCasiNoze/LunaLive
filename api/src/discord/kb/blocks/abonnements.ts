...
export const ABONNEMENTS_BLOCKS: KbBlock[] = [
  // ── Définition ────────────────────────────────────────────────────────────
  {
    id: "abo_definition",
    subject: "abonnements",
    ...
    what_it_is:
      "Un abonnement LunaLive permet de soutenir financièrement un streamer chaque mois. En échange, tu obtiens des avantages exclusifs sur son stream : badge visible dans le chat, emotes personnalisées, et bonus de rubis selon le niveau.",
    sensitivity: "low",
