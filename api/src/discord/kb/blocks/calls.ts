...
export const CALLS_BLOCKS: KbBlock[] = [
  // ── Définition ────────────────────────────────────────────────────────────
  {
    id: "calls_definition",
    subject: "calls",
    ...
    what_it_is:
      'Dans le jargon casino/gambling, un "call" est un pick de slot — une recommandation de jeu. Exemple : "je call Dog House" = je demande au streamer de jouer sur la slot Dog House.\n\nSur LunaLive, les calls fonctionnent en file d\'attente : chaque viewer peut soumettre son pick avec une mise en rubis. Le streamer traite les calls un par un en direct.',
    sensitivity: "low",
  ...
  // ── Viewer : position dans la file ────────────────────────────────────────
  {
    ...
    entry_points: ["LunaLive.fr → Page du streamer → Section Calls"],
    what_it_is:
      "L'ordre de la file dépend du poids de chaque participant. Le poids est lié à la mise en rubis (système weight_bp de 0 à 10 000). En cas d'égalité de poids, l'ordre d'arrivée est prioritaire (FIFO).",
    sensitivity: "low",
    confidence: "confirmed",
    code_refs: ["api/src/services/calls.ts"],
  },
  ...
  // ── Hunt ─────────────────────────────────────────────────────────────────
  {
    ...
    what_it_is:
      "La Hunt est une fonctionnalité avancée des calls où les mises sont en euros réels (et non en rubis). C'est une session de chasse casino avec des stakes réels, organisée par le streamer selon ses propres conditions.",
    sensitivity: "high",
    confidence: "confirmed",
    escalate: true,
    staff_notes:
      "La Hunt implique de l'argent réel. Ne jamais donner de détails sur les montants, règles ou modalités. Toujours escalader.",
    code_refs: ["api/src/services/calls.ts"],
  },
