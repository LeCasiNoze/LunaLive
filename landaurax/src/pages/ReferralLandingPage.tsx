...
import { parseAffiButtons, injectButtonsIntoIframe, parseFaqItems } from "../lib/affi_helpers";
import { buildM5V1TelegramButton, type M5V1Variant } from "../lib/m5_v1_apply";
...
type Config = {
  ...
  goldenHideName?: string;
  goldenLandingOnly?: string;
...
@media (min-width:900px){.hero-avatar{width:clamp(120px,12vw,176px);margin-bottom:22px}}
    ...
    if (tgUrl) {
      const tgBtn = buildM5V1TelegramButton(tgUrl, goldenVariant as M5V1Variant);
...
function redirectToLegacyReferral(_slug: string, navigate: ReturnType<typeof useNavigate>) {
